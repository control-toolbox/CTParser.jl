...
code = CTParser.reorder(e)
o = eval(CTParser.def_fun(e; order=true))
...
# cannot work even if reordered: error during parsing
o = CTParser.@def begin
    λ ∈ R^2, variable
    tf = λ₂
    t ∈ [0, tf], time
