# =============================================================================
# exa_linalg_w.jl - Symbolic wrappers for ExaModels.AbstractNode
#
...
# Wrapper types
export SymNumber, SymVector, SymMatrix, SymArray, AbstractSymArray

# Unwrap helpers
export unwrap_scalar, unwrap
...
# =============================================================================
# NOTE: Sparse array support commented out to avoid SparseArrays dependency
# If needed, add SparseArrays to dependencies and uncomment this section
