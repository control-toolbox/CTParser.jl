using Test
using Aqua
import CTParser: CTParser, subs, subs2, subs3, subs4, subs5, replace_call, has, concat, constraint_type, @def, prefix_fun, prefix_fun!, prefix_exa, prefix_exa!, e_prefix, e_prefix!, activate_backend, deactivate_backend, is_active_backend, @def_exa # todo: remove __default... (as soon as discretise_exa has been moved to CTDirect)
